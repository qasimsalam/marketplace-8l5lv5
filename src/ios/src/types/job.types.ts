/**
 * Job-related type definitions for the AI Talent Marketplace iOS mobile application
 * This file defines types, interfaces, and enumerations for jobs, proposals, and 
 * job search functionality optimized for mobile interfaces.
 */
...
/**
 * Interface for job creation and editing form values with mobile-specific file handling
 */
...
/**
 * Interface for proposal submission form values with mobile-specific file handling
 */
...
/**
 * Interface defining the jobs state in Redux store with mobile-specific refreshing state
 */
export interface JobsState {
  jobs: Job[];
  currentJob: Job | null;
  loading: boolean;
  refreshing: boolean; // Used for pull-to-refresh on mobile
  error: string | null;
  totalCount: number;
  currentPage: number;
  totalPages: number;
...
/**
 * Optimized subset of job data for displaying in mobile list views
 */
...
/**
 * Interface for the jobs context used with React Context API in the mobile app
 */
