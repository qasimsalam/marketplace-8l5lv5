 ...
 * 
 * This file defines enumerations, interfaces, and types representing user profiles
 * including freelancer and company profiles, portfolio items, work experience, 
 * education, certifications, and form value definitions for the Android application.
 * 
 * @version 1.0.0
 */
...
/**
 * Interface for the profile context that provides profile management functionality to React Native components
 */
export interface ProfileContextType {
  ...
  uploadProfileImage: (imageUri: string) => Promise<{ avatarUrl: string }>;
